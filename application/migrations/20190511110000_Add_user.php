...
//                'auto_increment' => TRUE
        ...
        $permission_insert_ids[] = $this->db->insert_id();
        $this->db->insert('permission', ['slug' => 'dashboard']);
        $permission_insert_ids[] = $this->db->insert_id();
        ...
        $permission_insert_ids[] = $this->db->insert_id();
        $this->db->insert('permission', ['slug' => 'element/index']);
        $permission_insert_ids[] = $this->db->insert_id();
        $this->db->insert('permission', ['slug' => 'element/modify']);
        $permission_insert_ids[] = $this->db->insert_id();
        $this->db->insert('permission', ['slug' => 'behavior/index']);
        $permission_insert_ids[] = $this->db->insert_id();
        $this->db->insert('permission', ['slug' => 'behavior/modify']);
        $permission_insert_ids[] = $this->db->insert_id();
        $this->db->insert('permission', ['slug' => 'permission/index']);
        $permission_insert_ids[] = $this->db->insert_id();
